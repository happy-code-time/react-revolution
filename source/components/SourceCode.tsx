...
class SourceCode extends React.Component< { [key: string]: any }, { [key: string]: any }> {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            inputCallback: typeof function(){} == typeof props.inputCallback ? props.inputCallback : undefined,
