...
class CloudMountain404 extends React.Component< { [key: string]: any }, { [key: string]: any }> {
    constructor(props) {
        super(props);

        this.state = {
            
            defaultClass: isString(props.defaultClass) ? props.defaultClass : 'CloudMountain404',
    ...
    render() {
        const { reactRouter, link, text404, text1, text2, bad, addClass, defaultClass, id } = this.state;
...
export default CloudMountain404;