...
class FilterMapping extends React.Component< { [key: string]: any }, { [key: string]: any }> {
    private refNode: any;
    private arrowBehaviorActive: boolean;
    private currentSelectedChild: any;
    private currentOpenedParent: any;
