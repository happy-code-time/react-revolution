...
class OutsideLeft extends React.Component< { [key: string]: any }, { [key: string]: any }> {
    private refNode: any;
    ...
    static getDerivedStateFromProps(props, state) {
        if (PropsCheck(['closeOnEsc', 'closeOnOutsideClick', 'uuid', 'holderData', 'animation', 'animationTimeout', 'contentData', 'addClass', 'defaultClass', 'id', 'holderData', 'contentData'], props, state)) {
            return {
                uuid: props.uuid,
                holderData: props.holderData,
                contentData: props.contentData,
    ...
    render() {
        const { defaultClass, addClass, id, holderData, displayMenu, dataClass, overlap } = this.state;
        ...
        return (
            ...
            >
                ...
                {
                    displayMenu &&
                    <div className={`menu menu-outside menu-outside-active ${overlap ? 'overlap' : ''}`}>
                        {
                            this.getMenu()
                        }
                    </div>
