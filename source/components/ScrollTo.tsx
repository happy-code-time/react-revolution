...
export default class ScrollTo extends React.Component< { [key: string]: any }, { [key: string]: any }> {
    constructor(props) {
        super(props);
    ...
    navigationTargetBottomOfWebpage(time) {
        let userOnXPosition: any = document.documentElement.scrollTop;
        let elementsOffsetTop: any = document.documentElement.scrollHeight;
