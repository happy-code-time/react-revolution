...
import StepLiveGeneration from './StepLiveGeneration';

class Step extends React.Component< { [key: string]: any }, { [key: string]: any }> {
    constructor(props) 
    {
        super(props);
            ...
            return (
                <div className="flex justify-content-between">
                    ...
                    <button 
                        ...
                        //@ts-ignore
                        style={bgStyle} 
                        onClick={() => this.slide(step, step + 1)}
                    >
                        {next}
                    </button>
                </div>
        ...
        if (step === data.length - 1) {
            return (
                <div className="flex justify-content-between">
                    ...
                    //@ts-ignore
                    style={bgStyle} onClick={() => this.slide(step, step - 1)}>
                        {previous}
                    </button>
                    <button className="btn-next" 
                    //@ts-ignore
                    style={bgStyle} onClick={() => this.checkSubmit()}>
                        {submit}
                    </button>
                </div>
            );
        ...
        return (
            <div className='' >
                ...
                <div className="content">
                    ...
                    {
                        liveGeneration && <StepLiveGeneration data={this.state.data} step={this.state.step} />
                    }
                    {
                        errorDataInside && currentError && !errorAlignTop &&
                        <span className="error">
