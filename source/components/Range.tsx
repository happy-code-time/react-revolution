...
class Range extends React.Component< { [key: string]: any }, { [key: string]: any }> {
    private reference_range: any;
    private current_moved: string;
    private mouseDownPersistet: boolean;
    private timeoutDisableLineClick: any;
    private timeoutCheckMouseDownPersisted: any;
    private allowedSize: any;
        ...
        return (
            <span className='min min-input user-select-none'>
                <input 
                    ...
                    {...(callbackOnEnter) && { onKeyDown: (e) => this.handleKeyDown(e) }}
                    {...minInputProps}
