...
class SliderItem extends React.Component< { [key: string]: any }, { [key: string]: any }> {
    private slideWidth: number;
    private movex: number;
    private mousestartx: number;
    private blockMove: boolean;
    private mouseClicksStart: number;
    private userMoving: boolean;
    private oldX: number;
    private mouseDirection: string;
    private abs: number;
    private isClickOnActionButton: any;
        ...
        return (
            <div className="pagination">
                <div className="actions">
                    {
                        this.getDataLengthArray().map((x, i) => {
                            return (
                                <span
    ...
    render() {
        const { addClass, defaultClass, id, staticData, paginationInside, allowMouseTouch, displayPagination, isUserCurrentlySliding, onSlideTime, animationTime, paginationType, dotsInside, displayDots, slidersUuid, slidesWidth, slidesTransform, slideWrapperWidth, itemsPerLine } = this.state;
        ...
        return (
            <div className='' >
                ...
                <div
                    ...
                    {...((true == allowMouseTouch) && { onTouchEnd: (e) => this.handleTouchEnd() })}
                    // Desktop
                    {...((true == allowMouseTouch) && { onClick: (e) => this.handleClick() })}
                    {...((true == allowMouseTouch) && { onMouseUp: (e) => this.handleMouseUp() })}
                    {...((true == allowMouseTouch) && { onMouseLeave: (e) => this.handleMouseLeave() })}
                >
                    {
                        paginationInside && displayPagination && 1 == paginationType && this.getButtonPreviousJsx()
                    }
